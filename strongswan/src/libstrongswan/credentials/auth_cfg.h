...
enum auth_rule_t {
	...
	/** IDr identity to use for S2b authentication exchange, identification_t* */
	AUTH_RULE_IDENTITY_APN,
	
	/** Hash and URL of a end-entity certificate, char* */
	AUTH_HELPER_BUNDLE_HASH_URL,
...
struct auth_cfg_t {
	...
	bool (*complies_v2)(auth_cfg_t *this, auth_cfg_t *constraints, bool log_error,
