...
cflags := -O2 -g -DYYTEXT_POINTER=1 -DHAVE_GETADDRINFO=1 -DHAVE_GETNAMEINFO=1 \
	...
	-DSYSCONFDIR=\"/vendor/etc/wide-dhcpv6\" -DLOCALDBDIR=\"/data/misc/dhcp\"
prebuilt_etc_files = dhcp6c.conf dhcp6cDNS.conf dhcp6cSIP.conf dhcp6cPD.conf dhcp6c.script dhcp6cPD.script dhcp6cctlkey dhcp6s.conf dhcp6sctlkey
...
$(foreach t, $(prebuilt_etc_files), \
  ...
  $(eval LOCAL_MODULE := $(t)) \
  $(eval LOCAL_MODULE_RELATIVE_PATH := wide-dhcpv6) \
